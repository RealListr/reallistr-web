...
# --- sprite.svg (ghost-ready outline icons) ---
cat > "$PUB/sprite.svg" <<'SVG'
...
echo "✅ Reallistr Ghost icons installed:"
echo "  - $PUB/sprite.svg"
echo "  - $COMP/Icon.tsx"
echo "  - $COMP/IconButton.tsx"
echo
echo "USAGE:"
echo "1) Include the sprite once near the top of your app shell (e.g., in index.html or root layout):"
echo '   <div style="display:none" aria-hidden="true"><?php include "/icons/sprite.svg"; ?></div>'
echo "   Or: copy the contents of public/icons/sprite.svg into your root layout."
echo "2) Use components:"
echo '   <Icon name="map-pin" tone="ghostOnDark" />'
